...
class YoloDataset(Dataset):
    ...
    def get_random_data(self, annotation_line, input_shape, jitter=.3, hue=.1, sat=1.5, val=1.5):
        ...
        # # place image with random clolor area
    ...
    def get_random_data_with_Mosaic(self, annotation_line, input_shape, hue=.1, sat=1.5, val=1.5):
        ...
        for line in annotation_line:
            ...
            # place images to correspond to the positions (four pictures) with random clolor area
            dx = place_x[index]
            dy = place_y[index]
            new_image = Image.new('RGB', (w, h),
                                  (np.random.randint(0, 255), np.random.randint(0, 255), np.random.randint(0, 255)))
    ...
    def __getitem__(self, index):
        ...
        if len(y) != 0:
            # convert from coordinates to percentage (0~1)
